...
namespace Syinpo.Core.EasyLicense.License.Exception
{
	/// <summary>
	///     Thrown when a valid license file can not be found on the client machine.
	/// </summary>
	[Serializable]
	public class LicenseFileNotFoundException : RhinoLicensingException
	{
		...
		public LicenseFileNotFoundException(string message, System.Exception inner)
			: base(message, inner)
		{
		}
